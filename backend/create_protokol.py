...
class Protokol():
    ...
    def create(self):
        ...
        normal_left(
            self.document,
            "Wnioskodawca został prawidłowo poinformowany o terminie "
            "posiedzenia Zespołu orzekającego oraz o możliwości wzięcia w nim "
            "udziału osobistego a także wskazanych specjalistów majacych "
